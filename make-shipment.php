...
<head>
  ...
  <title>Make Shipment || Appris Express Courier Services</title>
  <link rel="stylesheet"
          ...
          <div class="col-sm-12 col-md-12 col-lg-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Make Shipment</a></li>
              </ol>
            </nav>
            <h1 class="pagetitle__heading">Make Shipment</h1>
          </div><!-- /.col-lg-12 -->
        </div><!-- /.row -->
      </div><!-- /.container -->
    </section><!-- /.page-title -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <form class="request-quote-form" method="POST" action="processor.php">
              <div class="row mb-30">
                <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                  ...
                  <div class="form-group">
                    <input required  type="text" class="form-control" placeholder="Name" name="shi_name">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <label for="">Email</label>
                  <div class="form-group">
                    <input required  type="email" class="form-control" placeholder="Email" name="shi_email">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <label for="">Phone</label>
                  <div class="form-group">
                    <input required  type="tel" class="form-control" placeholder="Phone" name="shi_phone">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <label for="">Address</label>
                  <div class="form-group">
                    <input required  type="text" class="form-control" placeholder="Address" name="shi_address">
                  </div>
                </div><!-- /.col-lg-12 -->
              </div><!-- /.row -->
              <div class="row mb-30">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <label for="">Name</label>
                  <div class="form-group">
                    <input required  type="text" class="form-control" placeholder="Name" name="rec_name">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <label for="">Email</label>
                  <div class="form-group">
                    <input required  type="email" class="form-control" placeholder="Email" name="rec_email">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <label for="">Phone</label>
                  <div class="form-group">
                    <input required  type="tel" class="form-control" placeholder="Phone" name="rec_phone">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <label for="">Address</label>
                  <div class="form-group">
                    <input required  type="text" class="form-control" placeholder="Address" name="rec_address">
                  </div>
                </div><!-- /.col-lg-12 -->
              </div><!-- /.row -->
              <div class="row mb-10">
                ...
                <label>Package</label>
                  <div class="form-group">
                    <input required  type="text" class="form-control" placeholder="Package" name="package">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                <label>Status</label>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                  ...
                  <div class="form-group">
                    <input required  type="text" class="form-control" placeholder="Carrier" name="carrier">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                  ...
                  <div class="form-group">
                    <input required  type="text" class="form-control" placeholder="Total Weight, lbs" name="total_weight">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                  ...
                  <div class="form-group">
                    <input required  type="text" class="form-control" placeholder="Product" name="product">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <label for="">Qty</label>
                  <div class="form-group">
                    <input required  type="number" class="form-control" placeholder="Qty" name="qty">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                  ...
                  <div class="form-group">
                    <input required  type="date" class="form-control" name="ex_delivery_date">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <label for="">Departure Time</label>
                  <div class="form-group">
                    <input required  type="time" class="form-control" name="depature_time">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <label for="">Pick-up Date</label>
                  <div class="form-group">
                    <input required  type="date" class="form-control" name="pick_up_date">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <label for="">Pick-up Time</label>
                  <div class="form-group">
                    <input required  type="time" class="form-control" name="pick_up_time">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <label for="">Comments</label>
                  <div class="form-group">
                    <textarea type="text" class="form-control" placeholder="Enter comment..." name="comments"></textarea>
                  </div>
                </div><!-- /.col-lg-4 -->
              </div><!-- /.row -->
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <button type="submit" name="make_shipment" class="btn btn__secondary btn__block">Make Shipment</button>
                </div><!-- /.col-lg-12 -->
              </div><!-- /.row -->
            </form>
          </div><!-- /.col-lg-8 -->
