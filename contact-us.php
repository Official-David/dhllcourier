...
<head>
  ...
  <title>Contact Us || Appris Express Courier Services</title>
  <link rel="stylesheet"
...
try {
    ...
    $mail->Host       = 'apprisexpress.com';                     //Set the SMTP server to send through
    $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
    $mail->Username   = 'support@apprisexpress.com';                     //SMTP username
    $mail->Password   = 'apprisexpress1234';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->setFrom($email, $name);
    $mail->addAddress('support@toptracka.com', 'Support Team');     //Add a recipient
