...
<head>
  ...
  <title>About Us || Appris Express Courier Services </title>
  <link rel="stylesheet"
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="mainNavigation">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav__item"><a href="about-us.php" class="nav__item-link active">About Us</a></li>
              <li class="nav__item">
          ...
          <div class="col-sm-12 col-md-12 col-lg-7">
            <div class="row heading heading-2">
              <div class="col-sm-12 col-md-12 col-sm-12">
                <h2 class="heading__title">Safe And Reliable Appris Express Courier Services Saves Your
                  Time!</h2>
              </div><!-- /.col-lg-12 -->
                ...
                <div class="carousel owl-carousel carousel-dots" data-slide="1" data-slide-md="1" data-slide-sm="1"
                  ...
                  <div class="fancybox-item">
                    ...
                    <div class="fancybox__content">
                      ...
                      <p class="fancybox__desc">Utilizing latest communications, tracking processing software, and
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 equal-height">
            <div class="inner-padding">
              <div class="heading heading-2 mb-50">
                <h2 class="heading__title color-white">Logistics & Transport Solutions Saves Your Time!</h2>
                <p class="heading__desc color-white">Appris Express Courier Services is a worldwide Logistics operator providing full
              ...
              <a href="track-shipment.php" class="btn  btn__white btn__hover2 btn__lg">Track Shipment</a>
            </div>
          </div><!-- /.col-lg-6 -->
            ...
            <div class="owl-thumbs" data-slider-id="1">
              <button class="owl-thumb-item">
                <span class="testimonial__meta">
                  ...
                  <span class="testimonial__meta-title">Peter Aman</span>
                  <span class="testimonial__meta-desc">Business Owner</span>
   ...
   <section id="cta1" class="cta cta-1 border-top pt-40 pb-10">
              ...
              <div id="accordion">
                <div class="accordion-item">
                  <div class="accordion__item-header opened" data-toggle="collapse" data-target="#collapse1">
                    <a class="accordion__item-title" href="#">Head Office</a>
    ...
    <footer id="footer" class="footer footer-1">
      <div class="footer-top">
        <div class="container">
          <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3 footer__widget footer__widget-about">
