...
<head>
  ...
  <title>Add Shipment History || Appris Express Courier Services</title>
  <link rel="stylesheet"
          ...
          <div class="collapse navbar-collapse" id="mainNavigation">
            <ul class="navbar-nav ml-auto">
              <li class="nav__item with-dropdown">
                <a href="login.php" class="nav__item-link">Home</a>
          ...
          <div class="col-sm-12 col-md-12 col-lg-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Add Shipment History</a></li>
              </ol>
            </nav>
            <h1 class="pagetitle__heading">Add Shipment History</h1>
          </div><!-- /.col-lg-12 -->
        </div><!-- /.row -->
      </div><!-- /.container -->
    </section><!-- /.page-title -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <form class="request-quote-form" method="POST" action="add-history.php">
              <div class="row mb-10">
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <h5 class="form__title">Add Shipment History</h5>
                  <div class="divider__line divider__theme divider__sm mb-30"></div>
                </div><!-- /.col-lg-12 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                <label for="">Tracking ID</label>
                  <div class="form-group">
                    <input required placeholder="Tracking ID" type="text" class="form-control" name="history_tracking_id">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                <label for="">Date</label>
                  <div class="form-group">
                    <input required  type="date" class="form-control" name="history_date">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                <label for="">Time</label>
                  <div class="form-group">
                    <input required  type="time" class="form-control" name="history_time">
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                <label for="">location</label>
                  <div class="form-group form-group-select" >
                    <select class="form-control" name="history_location">
                ...
                <label>Status</label>
                  <div class="form-group form-group-select">
                    <select class="form-control" name="history_statu">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                  ...
                  <div class="form-group">
                    <textarea type="text" class="form-control" placeholder="Enter remarks..." name="history_remark"></textarea>
                  </div>
                </div><!-- /.col-lg-4 -->
              </div><!-- /.row -->
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <button type="submit" name="add-shipment-history" class="btn btn__secondary btn__block">Add Shipment History</button>
                </div><!-- /.col-lg-12 -->
              </div><!-- /.row -->
            </form>
          </div><!-- /.col-lg-8 -->
