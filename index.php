            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-8">
                <div class="slide__content">
                  ...
                  <p class="slide__desc">Providing flexible, improved service levels, and accelerated
                    delivery.</p>
                  <a href="services.php" class="btn btn__white mr-40">Our Services</a>
                </div><!-- /.slide-content -->
              </div><!-- /.col-lg-8 -->
            </div><!-- /.row -->
          </div><!-- /.container -->
            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-8">
                <div class="slide__content">
                  ...
                  <p class="slide__desc">Providing flexible, improved service levels, and accelerated delivery.</p>
                  <a href="track-shipment.php" class="btn btn__white mr-40">Track Shipment</a>
                </div><!-- /.slide-content -->
              </div><!-- /.col-lg-8 -->
            </div><!-- /.row -->
          </div><!-- /.container -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-7">
            <div class="row heading heading-2">
              <div class="col-sm-12 col-md-12 col-sm-12">
                <h2 class="heading__title">Safe, Reliable And Express Courier & Transport Solutions
            ...
            <div class="row">
              <div class="col-sm-4 col-md-4 col-lg-4">
                <div class="counter-item">
                  ...
                  <h4><span class="counter">1,238</span><span>m</span></h4>
          ...
          <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="request__form">
              ...
              <div class="tab-content">
                ...
                <form method="post" action="shipment-details.php">
          ...
          <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="fancybox-item">
              ...
              <div class="fancybox__content">
                ...
                <p class="fancybox__desc">We enhance our Courier operations by relieving you of the worries associated
